...
export default function Admin() {
   ...
   const  handleUpadateToBlog =async(e)=>{
       e.preventDefault()
      await dispatch(UpdateBlogAction(updateId,{title:mtitle,shortDesc:mshortDesc,desc:mdesc}))
   ...
   const handleImage = e => {
    ...
    const handleAddToBlog = async (e) => {
        ...
        const { data } = await axios.post("http://localhost:5000/api/v1/blogs", fd,config)
                       ...
                       <tbody>
                           {
                               reduxBlog.map(item=>(
                                ...
                                <td> 
                                  ...
                                  <img src={`http://localhost:5000/${item.image}`} alt={item.image} height={100} width={100} />
                                </td>
                                <td>
               ...
               <div class="modal-dialog">
                 <div class="modal-content">
                   ...
                   <form onSubmit={handleUpadateToBlog}>
                                ...
                                <button className="btn btn-success btn-lg">Add Blog</button>
                            </form>
                   </div>
